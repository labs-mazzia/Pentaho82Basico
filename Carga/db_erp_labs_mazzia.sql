...
CREATE TABLE IF NOT EXISTS `erp_labs_mazzia`.`erp_paciente` (
  ...
  INDEX `fk_paciente_cidade_idx` (`id_cidade` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `erp_labs_mazzia`.`erp_atendimento` (
  ...
  INDEX `idx_paciente` (`id_paciente` ASC) VISIBLE,
  INDEX `idx_dt_atdto` (`atd_data_atdto` ASC) VISIBLE,
  INDEX `idx_dt_alta` (`atd_data_alta` ASC) VISIBLE,
  INDEX `idx_cid` (`id_cid` ASC) VISIBLE,
  INDEX `idx_interna` (`id_tipo_interna` ASC) VISIBLE,
  INDEX `idx_especialidade` (`id_especialidade` ASC) VISIBLE,
  INDEX `idx_procedimento` (`id_procedimento` ASC) VISIBLE,
  INDEX `idx_recepcao` (`id_recepcao` ASC) VISIBLE,
  INDEX `idx_faturamento` (`atd_tipo_fatura` ASC) VISIBLE,
  INDEX `idx_mot_alta` (`id_motalta` ASC) VISIBLE,
  INDEX `idx_obito` (`atd_obito` ASC) VISIBLE,
  INDEX `idx_ano_atd` (`atd_atdto_ano` ASC) VISIBLE,
  INDEX `idx_mes_atd` (`atd_atdto_mes` ASC) VISIBLE,
  INDEX `idx_periodo_atd` (`atd_atdto_periodo` ASC) VISIBLE,
  INDEX `idx_ano_alta` (`atd_alta_ano` ASC) VISIBLE,
  INDEX `idx_mes_alta` (`atd_alta_mes` ASC) VISIBLE,
  INDEX `idx_periodo_alta` (`atd_alta_periodo` ASC) VISIBLE,
